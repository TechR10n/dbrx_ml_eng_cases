...
# DBTITLE 0,--i18n-2f91cda5-ac18-4779-9bc1-9bafd66a1043
# MAGIC %md
# MAGIC
# MAGIC ## Requirements
# MAGIC
...
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/FS_MLProd_model_registry-v2.png" alt="step12" width="800"/>
# MAGIC
# MAGIC </br>
# MAGIC </br>
# MAGIC Meanwhile you can find the registered model appears also on the Feature Store UI.
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/FS_MLProd_feature_store_UI_1-v2.png" alt="step12" width="800"/>
# MAGIC <img src="https://files.training.databricks.com/images/FS_MLProd_feature_store_UI_2-v2.png" alt="step12" width="800"/>
