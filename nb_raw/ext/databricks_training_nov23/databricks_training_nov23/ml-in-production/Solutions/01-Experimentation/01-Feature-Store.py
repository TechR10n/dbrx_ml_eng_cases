...
# DBTITLE 0,--i18n-a3b3f387-e215-4a91-bc84-abefbcc4b628
# MAGIC %md
# MAGIC
# MAGIC ## Requirements
# MAGIC
...
# MAGIC * **`partition_columns`** - Column(s) used to partition the feature table. **Note:** As a best practice, Databricks recommends you do NOT partition tables that contains less than a terabyte of data. 
# MAGIC
...
fs.create_table(
    ...
    primary_keys=["id"],
    df=airbnb_df,
    partition_columns=["neighbourhood"], # for such a small dataset we shouldn't partition, this is just for demonstration
...
# MAGIC
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/FS_Nav-v2.png" alt="step12" width="150"/>
...
# MAGIC <br>
# MAGIC <br>
# MAGIC <img src="https://s3.us-west-2.amazonaws.com/files.training.databricks.com/images/feature_store_details-v2.png" alt="step12" width="1000"/>
...
# MAGIC
# MAGIC
# MAGIC By navigating back to the UI, we should see that the modified date has changed and a new column has been added to the feature list. 
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/feature_store_delete-v2.png">
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/feature_store_delete_window-v2.png" width=600>
