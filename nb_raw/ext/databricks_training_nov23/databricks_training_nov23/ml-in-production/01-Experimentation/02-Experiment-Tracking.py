...
# DBTITLE 0,--i18n-64cd794f-46bf-4400-aad3-e0c45cfe00f0
# MAGIC %md
# MAGIC
# MAGIC ## Requirements
# MAGIC
...
# MAGIC
# MAGIC <div><img src="https://files.training.databricks.com/images/mlflow_exp_ui-v2.png" style="height: 400px; margin: 20px"/></div>
...
# MAGIC
# MAGIC <div><img src="https://files.training.databricks.com/images/mlflow_model_page-v2.png" style="height: 400px; margin: 20px"/></div>
...
# MAGIC **A:** <a href="https://www.statlearning.com/" target="_blank">_An Introduction to Statistical Learning_</a> is a good starting point for the themes and basic approaches to machine learning.
# MAGIC
