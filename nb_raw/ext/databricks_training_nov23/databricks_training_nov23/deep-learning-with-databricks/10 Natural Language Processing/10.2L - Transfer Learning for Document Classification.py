...
# MAGIC 2. You will use **`UniversalSentenceEncoder`** for the first time. Refer to the <a href="https://nlp.johnsnowlabs.com/docs/en/transformers#universalsentenceencoder" target="_blank">documentation</a> on Universal Sentence Encoder to see an example of how you can build such an encoder.  This is a <a href="https://arxiv.org/pdf/1803.11175.pdf" target="_blank">pretrained model published by Google on TFhub</a> and SparkNLP provides a wrapper to use this model efficiently with Spark.
# MAGIC 3. You will need to build a <a href="https://nlp.johnsnowlabs.com/docs/en/annotators#classifierdl" target="_blank">text classifier</a>. 
