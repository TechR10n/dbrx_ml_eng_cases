...
with mlflow.start_run() as local_run:
    ...
    mlflow.tensorflow.log_model(local_model, artifact_path="local_model")
...
loaded_model = mlflow.tensorflow.load_model(model_uri=f"runs:/{local_run.info.run_id}/local_model")
...
with mlflow.start_run() as dist_run:
    ...
    mlflow.tensorflow.log_model(dist_model, "dist_model")

# COMMAND ----------

loaded_dist_model = mlflow.tensorflow.load_model(model_uri=f"runs:/{dist_run.info.run_id}/dist_model")
