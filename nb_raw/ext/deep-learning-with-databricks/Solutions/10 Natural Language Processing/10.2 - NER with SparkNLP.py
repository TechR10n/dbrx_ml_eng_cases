...
# MAGIC %pip install spark-nlp==4.2.1 spark-nlp-display==4.1
...
# MAGIC %md
# MAGIC [HuggingFace](https://huggingface.co/) is another popular NLP library and hub for transformers and generative AI. Hugging Face has recently been integrated into MLflow and is able to be used in conjunction with Databricks and Spark. You'll interact with the `mlflow.transformers` to access the functionallity of transformers within MLflow.  
# MAGIC
# MAGIC * [Hugging Face Transformers](https://docs.databricks.com/machine-learning/train-model/huggingface/index.html)
# MAGIC * [Getting started with NLP using Hugging Face transformers pipelines](https://www.databricks.com/blog/2023/02/06/getting-started-nlp-using-hugging-face-transformers-pipelines.html)
